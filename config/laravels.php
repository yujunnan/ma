...
return [
    ...
    'laravel_base_path'        => "/var/www/mojito",
    'inotify_reload'           => [
        'enable'        => env('LARAVELS_INOTIFY_RELOAD', false),
        'watch_path'    => "/var/www/mojito",
        'file_types'    => ['.php'],
        'excluded_dirs' => [],
        'log'           => true,
    ],
    ...
    'swoole'                   => [
        ...
        'pid_file'           => "/var/www/mojito/storage/laravels.pid",
        'log_file'           => "/var/www/mojito/storage/logs/swoole-]".date('Y-m').".log",
        'log_level'          => 4,
        'document_root'      => "/var/www/mojito/public",
